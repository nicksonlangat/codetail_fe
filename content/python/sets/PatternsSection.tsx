...
export function PatternsSection() {
  return (
    <section>
      ...
      <h3 className="text-base font-semibold text-brand-text mb-3">Fast duplicate detection</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Comparing{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">len(items)</code>{" "}
        against{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">len(set(items))</code>{" "}
...
True`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Finding common and unique elements</h3>
...
total: 6`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">frozenset as a dict key</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Sets are mutable, so they cannot be used as dict keys or placed inside sets.{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">frozenset</code>{" "}
...
True`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Set comprehensions</h3>
