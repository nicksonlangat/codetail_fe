...
export function CreatingSetsSection() {
  return (
    <section>
      <h2 id="creating-sets" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Creating sets
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        A set is an unordered collection of <Term term="unique">unique</Term> elements.
        Each value appears at most once. Adding a duplicate does nothing. Sets are
        backed by a hash table, membership tests are O(1) regardless of size.
      </p>
...
{'h', 'e', 'l', 'o'}`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Uniqueness is enforced automatically</h3>
