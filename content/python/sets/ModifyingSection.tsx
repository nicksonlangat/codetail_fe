...
export function ModifyingSection() {
  return (
    <section>
      <h2 id="modifying-sets" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Modifying sets
      </h2>
...
set()`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">In-place operations</h3>
