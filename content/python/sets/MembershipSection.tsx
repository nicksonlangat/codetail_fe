...
export function MembershipSection() {
  return (
    <section>
      <h2 id="membership" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Membership testing
      </h2>
...
True`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">When to use a set for lookups</h3>
...
set:  0.001 ms`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Subset and superset tests</h3>
...
print(required <= user_perms)           # True  (required is a subset of user_perms)
