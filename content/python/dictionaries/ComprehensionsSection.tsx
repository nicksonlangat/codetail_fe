...
# {'Alice': 92, 'Carol': 85}`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Inverting a dict</h3>
...
Japan`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Building from two lists</h3>
