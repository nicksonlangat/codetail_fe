...
export function ModifyingSection() {
  return (
    <section>
      <h2 id="modifying" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
...
viewer`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Merging dicts</h3>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">.update()</code>.
...
{'theme': 'dark', 'lang': 'fr', 'timeout': 60}`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Useful methods</h3>
