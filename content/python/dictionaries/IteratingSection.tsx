...
export function IteratingSection() {
  return (
    <section>
      <h2 id="iterating" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Iterating
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Dictionaries have three view objects:{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">.keys()</code>,{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">.values()</code>, and{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">.items()</code>.
...
Carol: 85`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Sorted iteration</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Python 3.7+ guarantees that dicts preserve insertion order. If you need a
        different order, wrap the iteration in{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">sorted()</code>.
...
Bob: 78`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Never modify during iteration</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Adding or removing keys while iterating raises a{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">RuntimeError</code>.
