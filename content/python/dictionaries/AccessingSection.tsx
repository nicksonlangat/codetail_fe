...
export function AccessingSection() {
  return (
    <section>
      <h2 id="accessing" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Accessing values
      </h2>
...
5432`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">setdefault()</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">.setdefault(key, default)</code>{" "}
...
# {'fruit': ['apple', 'banana'], 'veg': ['carrot']}`}
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mt-6 mb-4">
        ...
        <code className="font-mono text-[12px] bg-brand-surface px-1.5 py-0.5 rounded">?</code>{" "}
        are not in the dict. Switch between{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">d["key"]</code>{" "}
        and{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">d.get("key")</code>{" "}
