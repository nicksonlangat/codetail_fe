...
export function CreatingDictsSection() {
  return (
    <section>
      <h2 id="creating-dicts" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Creating dictionaries
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        A dictionary maps <Term term="key">keys</Term> to values. Every key is unique.
        Looking up a value by key takes the same time whether the dictionary has 10
        items or 10 million, because dictionaries are backed by a{" "}
...
5432`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">dict.fromkeys()</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        When you need a dict with a fixed set of keys and a default value for each,{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">dict.fromkeys()</code>{" "}
