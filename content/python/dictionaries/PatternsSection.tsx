...
export function PatternsSection() {
  return (
    <section>
      ...
      <h3 className="text-base font-semibold text-brand-text mb-3">Grouping records</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        The most common dict pattern: start with a flat list, group it by some attribute.
        A{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">defaultdict(list)</code>{" "}
        or{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">setdefault</code>{" "}
        both work.
      </p>
...
# {'Engineering': ['Alice', 'Carol'], 'Design': ['Bob', 'Dan']}`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Memoization / caching</h3>
...
def fib2(n: int) -> int:
    ...
    return fib2(n - 1) + fib2(n - 2)`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Safe nested access</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Deeply nested dicts are common in API responses. Chaining{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">.get()</code>{" "}
        avoids{" "}
...
None`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Dispatch table</h3>
