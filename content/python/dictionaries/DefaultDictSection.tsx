...
export function DefaultDictSection() {
  return (
    <section>
      <h2 id="defaultdict" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">set</code>, or a lambda.
      </p>
...
{'h': 1, 'e': 1, 'l': 3, 'o': 2, ' ': 1, 'w': 1, 'r': 1, 'd': 1}`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Counter</h3>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">.most_common(n)</code>{" "}
