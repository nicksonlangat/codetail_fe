...
export function AssignmentPatternsSection() {
  return (
    <section>
      <h2 id="assignment-patterns" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Assignment patterns
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-6">
        Python has several assignment forms beyond the basic{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">x = value</code>.
        Each one has a specific use case.
      </p>

      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Augmented assignment</h3>
...
hello world`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Multiple assignment</h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
...
[1] [1]`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Tuple unpacking</h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
...
[2, 3, 4]`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Walrus operator (Python 3.8+)</h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        The{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">:=</code> operator
