...
export function BuiltInTypesSection() {
  return (
    <section>
      <h2 id="built-in-types" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">
        <code className="font-mono text-brand-primary">int</code>: whole numbers
      </h3>
...
print(factorial_20 * 100)`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">
        <code className="font-mono text-brand-primary">float</code>: decimal numbers
      </h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
...
False`}
      />
      <div className="border-l-2 border-brand-warning bg-brand-warning/5 pl-4 py-3 rounded-r-lg mt-3 mb-4">
        <p className="text-[13px] text-brand-text-muted">
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">0.1 + 0.2 != 0.3</code>{" "}
          ...
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">decimal.Decimal</code>.
        </p>
      </div>

      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">
        <code className="font-mono text-brand-primary">str</code>: text
      </h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
...
print(type(name))   # <class 'str'>`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">
        <code className="font-mono text-brand-primary">bool</code>: true or false
      </h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Booleans represent truth values. There are exactly two:{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">True</code> and{" "}
...
0`}
      />
      <div className="border-l-2 border-brand-primary bg-brand-primary/5 pl-4 py-3 rounded-r-lg mt-3 mb-4">
        <p className="text-[13px] text-brand-text-muted italic">
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">True</code> and{" "}
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">False</code> are
          literally just <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">1</code> and{" "}
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">0</code> with extra
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">
        <code className="font-mono text-brand-primary">None</code>: the absence of a value
      </h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">None</code> is
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">None</code> object
        in all of Python.
      </p>
      <CodeBlock
