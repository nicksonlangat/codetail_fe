...
export function WhatIsAVariableSection() {
  return (
    <section>
      <h2 id="names-not-boxes" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Names, not boxes
      </h2>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mt-4 mb-4">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded mx-1">x</code>
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Where this matters: aliasing</h3>
...
False`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Why integers feel different</h3>
...
11`}
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mt-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">b = b + 1</code>{" "}
        doesn&apos;t modify the integer{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">10</code>.
        It creates a new integer{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">11</code>{" "}
        and moves the sticky note. The object{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">a</code>{" "}
