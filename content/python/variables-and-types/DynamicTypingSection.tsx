...
export function DynamicTypingSection() {
  return (
    <section>
      <h2 id="dynamic-typing" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Dynamic typing
      </h2>
...
<class 'list'>`}
      ...
      <div className="border-l-2 border-brand-primary bg-brand-primary/5 pl-4 py-3 rounded-r-lg mt-4 mb-6">
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Type annotations: hints, not rules</h3>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">mypy</code> and
...
[1, 2, 1, 2]`}
      ...
      <div className="border-l-2 border-brand-warning bg-brand-warning/5 pl-4 py-3 rounded-r-lg mt-3">
        <p className="text-[13px] text-brand-text-muted">
          ...
          Run <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">mypy</code>{" "}
