...
export function FoundationsSection() {
  return (
    <section>
      <h2 id="what-is-a-string" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        What is a string?
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        A string is an ordered, <Term term="immutable">immutable</Term>{" "}
        <Term term="sequence">sequence</Term> of <Term term="unicode">Unicode</Term>{" "}
...
s[0] = "H"  # Python won't allow this`}
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mt-6 mb-4">
        Strings are also <Term term="sequence">sequences</Term>, so everything you know about
        Python sequences applies:{" "}
