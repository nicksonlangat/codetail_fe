...
export function CreationSection() {
  return (
    <section>
      <h2 id="creating-strings" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Creating strings
      </h2>
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Single and double quotes</h3>
...
html  = 'She said "hello"'        # double quote inside, no escape`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Triple quotes</h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
...
'''`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Raw strings</h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Prefix with{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">r</code> to
        treat backslashes literally. Essential for Windows file paths and regex patterns.
      </p>
      <CodeBlock
...
pattern = r"\\d+"   # matches one or more digits`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">f-strings (Python 3.6+)</h3>
      <div className="border-l-2 border-brand-primary bg-brand-primary/5 pl-4 py-3 rounded-r-lg mb-4">
...
Pi: 3.14`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">str() constructor</h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
