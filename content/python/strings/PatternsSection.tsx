...
export function PatternsSection() {
  return (
    <section>
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Clean and normalize user input</h3>
...
if username == "alice":
    print("Found user")`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Parse delimited data</h3>
      <p className="text-[14px] text-brand-text/80 mb-3">
...
print(f"{name} is a {role} in {city}")`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Build URLs and paths safely</h3>
      <CodeBlock
...
/home/alice/documents/report.pdf`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Truncate text for display</h3>
      <CodeBlock
...
jumped over the lazy dog`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Filter files by extension</h3>
      <CodeBlock
