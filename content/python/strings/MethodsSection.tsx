...
export function MethodsSection() {
  return (
    <section>
      <h2 id="string-methods" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        String methods
      </h2>
      ...
      <div className="border-l-2 border-brand-primary bg-brand-primary/5 pl-4 py-3 rounded-r-lg mt-6">
        <p className="text-[13px] text-brand-text-muted">
          ...
          <code className="font-mono bg-brand-surface px-1 rounded">s.upper()</code> without
          assigning the result does nothing to{" "}
          <code className="font-mono bg-brand-surface px-1 rounded">s</code>.
        </p>
      </div>
    </section>
  );
