...
export function MapSection() {
  return (
    <section>
      <h2 id="map" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Transforming lists
      </h2>
...
['HELLO', 'WORLD', 'PYTHON']`}
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mt-6 mb-3">
        Python&apos;s built-in{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">map()</code>{" "}
