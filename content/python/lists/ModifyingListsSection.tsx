...
export function ModifyingListsSection() {
  return (
    <section>
      <h2 id="modifying-lists" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Modifying lists
      </h2>
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Adding items</h3>
      <CodeBlock
...
False`}
      ...
      <div className="border-l-2 border-brand-warning bg-brand-warning/5 pl-4 py-3 rounded-r-lg mt-3 mb-6">
        <p className="text-[13px] text-brand-text-muted">
          <strong>append vs extend:</strong>{" "}
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">fruits.append(["fig", "grape"])</code>{" "}
          adds the list as a single nested element.{" "}
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">fruits.extend(["fig", "grape"])</code>{" "}
          adds each item individually.
        </p>
      </div>

      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Removing items</h3>
      <CodeBlock
...
[]`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Other operations</h3>
      <CodeBlock
