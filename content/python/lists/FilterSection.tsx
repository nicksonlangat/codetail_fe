...
export function FilterSection() {
  return (
    <section>
      <h2 id="filter" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Filtering lists
      </h2>
...
['hello', 'world', 'python']`}
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mt-6 mb-3">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">filter()</code>{" "}
