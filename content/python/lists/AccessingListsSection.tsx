...
export function AccessingListsSection() {
  return (
    <section>
      <h2 id="accessing-lists" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
...
['e', 'd', 'c', 'b', 'a']`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Slice assignment</h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
...
[]`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Nested lists</h3>
      <CodeBlock
        code={`grid = [
    [1, 2, 3],
    [4, 5, 6],
