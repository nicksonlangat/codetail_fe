...
export function SortingSection() {
  return (
    <section>
      <h2 id="sorting" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Sorting
      </h2>
...
[9, 5, 4, 3, 2, 1, 1]`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Sorting with a key</h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        The <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">key</code>{" "}
