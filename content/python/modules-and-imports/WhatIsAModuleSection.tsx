...
export function WhatIsAModuleSection() {
  return (
    <section>
      <h2 id="what-is-a-module" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        What is a module?
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        A module is any{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">.py</code> file.
        When you write{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">import math</code>,
        Python finds{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">math.py</code>{" "}
...
<class 'module'>`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Your own modules</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Any file you write is importable as a module. Save this as{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">utils.py</code>{" "}
...
30`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">The __name__ guard</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Every module has a built-in{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">__name__</code>{" "}
        attribute. When Python runs a file directly,{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">__name__</code>{" "}
        is set to{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">&quot;__main__&quot;</code>.
