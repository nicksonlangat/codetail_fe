...
export function SysPathSection() {
  return (
    <section>
      <h2 id="sys-path" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        How Python finds modules
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        When you write{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">import utils</code>,
        Python searches a list of directories called{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">sys.path</code>{" "}
        in order. It imports the first match it finds. If nothing matches, you
        get{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">ModuleNotFoundError</code>.
      </p>
...
/usr/lib/python3.12/lib-dynload`}
      ...
      <ol className="list-decimal list-inside space-y-1.5 text-[15px] text-brand-text/90 mb-6 pl-1">
        <li>The directory containing the script being run (or the current directory in the REPL)</li>
        <li>
          Directories listed in the{" "}
          <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">PYTHONPATH</code>{" "}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Why ModuleNotFoundError happens</h3>
...
# fix: structure as a package and install it properly`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Module caching</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Python caches every imported module in{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">sys.modules</code>.
