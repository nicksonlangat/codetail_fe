...
export function ImportSyntaxSection() {
  return (
    <section>
      <h2 id="import-syntax" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Import syntax
      </h2>
      ...
      <h3 className="text-base font-semibold text-brand-text mt-6 mb-3">import module</h3>
...
print(os.getcwd())   # /home/user/project`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">from module import name</h3>
...
3.141592653589793`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">import module as alias</h3>
...
today = dt.date.today()`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Wildcard imports, avoid them</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">from module import *</code>{" "}
...
from math import sqrt`}
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mt-4 mb-4">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">__init__.py</code>{" "}
        to re-export a curated public API, controlled by{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">__all__</code>.
      </p>
    </section>
  );
}
