...
export function RelativeImportsSection() {
  return (
    <section>
      <h2 id="relative-imports" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Relative imports
      </h2>
...
from ..utils import format_date    # specific name from parent module`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Absolute vs relative, which to prefer</h3>
...
from ..utils import format_date`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Circular imports</h3>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">ImportError</code>{" "}
