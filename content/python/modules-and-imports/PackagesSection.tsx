...
export function PackagesSection() {
  return (
    <section>
      <h2 id="packages" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Packages
      </h2>
...
from myapp.api.auth import verify_token  # name from a nested module`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">__init__.py as a public API</h3>
...
from myapp.models import User`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">__all__ controls what gets exported</h3>
...
def _build_query(params):   # underscore = private by convention
    pass`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Namespace packages</h3>
