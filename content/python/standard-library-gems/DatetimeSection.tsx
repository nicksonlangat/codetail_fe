...
export function DatetimeSection() {
  return (
    <section>
      <h2 id="datetime" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        datetime
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        The{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">datetime</code>{" "}
        module provides three types you will use constantly:{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">date</code>{" "}
        (year, month, day),{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">datetime</code>{" "}
        (date plus time), and{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">timedelta</code>{" "}
...
291`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Formatting and parsing</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">strftime</code>{" "}
        formats a datetime to a string.{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">strptime</code>{" "}
...
<class 'datetime.datetime'>`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Timezone-aware datetimes</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">datetime.now()</code>{" "}
...
UTC`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Common format codes</h3>
