...
export function JsonSection() {
  return (
    <section>
      <h2 id="json" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        json
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Python&apos;s{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">json</code>{" "}
        module converts between Python objects and JSON text. The four functions you
        need:{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">loads</code>{" "}
        and{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">dumps</code>{" "}
        work with strings;{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">load</code>{" "}
        and{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">dump</code>{" "}
...
{"scores": [95, 87, 91], "passed": true}
{
  ...
  "passed": true
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Reading and writing files</h3>
...
print(loaded["port"])   # 8080`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Type mapping</h3>
...
Object of type set is not JSON serializable`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Custom encoders</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Subclass{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">json.JSONEncoder</code>{" "}
