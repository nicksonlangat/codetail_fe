...
export function CollectionsSection() {
  return (
    <section>
      <h2 id="collections" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        collections
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        The{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">collections</code>{" "}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-6 mb-3">Counter</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">Counter</code>{" "}
        counts occurrences of elements in any iterable. It is a dict subclass, so
        missing keys return 0 instead of raising{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">KeyError</code>.
      </p>
...
Counter({'cats': 2})`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">defaultdict</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">defaultdict</code>{" "}
        takes a factory function. When you access a missing key, it calls the factory,
        stores the result, and returns it. No more{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">if key not in d: d[key] = []</code>.
      </p>
...
{'a': 2, 'b': 2, 'c': 2}`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">deque</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        A{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">deque</code>{" "}
...
deque([3, 4, 5], maxlen=3)`}
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">namedtuple</code>{" "}
