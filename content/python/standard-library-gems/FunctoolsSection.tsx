...
export function FunctoolsSection() {
  return (
    <section>
      <h2 id="functools" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        functools
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">functools</code>{" "}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-6 mb-3">lru_cache, memoization in one line</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">@lru_cache</code>{" "}
...
CacheInfo(hits=33, misses=36, maxsize=128, currsize=36)`}
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Python 3.9 added{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">@cache</code>{" "}
        as a shorthand for{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">@lru_cache(maxsize=None)</code>,
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">partial, pre-fill arguments</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">partial</code>{" "}
...
['pyproject.toml', 'pytest.ini']`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">reduce, fold a sequence</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">reduce</code>{" "}
...
[1, 2, 3, 4, 5, 6]`}
      ...
      <div className="border-l-2 border-brand-primary bg-brand-primary/5 pl-4 py-3 rounded-r-lg mb-6 mt-4">
