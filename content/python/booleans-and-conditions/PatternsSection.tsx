...
export function PatternsSection() {
  return (
    <section>
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Guard clauses: exit early</h3>
...
def process_order(order):
    ...
    return order.submit()`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">all() and any()</h3>
      <p className="text-[14px] text-brand-text/80 mb-3">
        Check conditions across a collection without writing a loop.{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">all()</code>{" "}
        returns True if every item is truthy.{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">any()</code>{" "}
        returns True if at least one is. Both short-circuit.
      </p>
      <CodeBlock
...
False`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Conditional imports</h3>
      <CodeBlock
        code={`import sys
...
if sys.platform == "win32":
    ...
    winreg = None`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Conditions that read like English</h3>
      <p className="text-[14px] text-brand-text/80 mb-3">
...
if "banana" in items and len(items) > 2:
    print("found banana in a full cart")`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Avoid comparing to True or False</h3>
      <CodeBlock
        code={`is_active = True
