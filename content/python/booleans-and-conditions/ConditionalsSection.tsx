...
export function ConditionalsSection() {
  return (
    <section>
      <h2 id="conditionals" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Conditionals
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">if</code>{" "}
        statements execute a block when a condition is truthy. Any expression can be a
        condition, Python calls{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">bool()</code>{" "}
        on it automatically.
      </p>
...
print(grade)    # B`}
      ...
      <div className="border-l-2 border-brand-primary bg-brand-primary/5 pl-4 py-3 rounded-r-lg mb-6">
        <p className="text-[13px] text-brand-text-muted italic">
          ...
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">TabError</code>.
        </p>
      </div>

      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Truthiness in conditions</h3>
...
zero count`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Conditional expressions (ternary)</h3>
...
Result: pass`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">match statements (Python 3.10+)</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Python 3.10 added structural pattern matching. It&apos;s more powerful than a chain of{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">elif</code>s
