...
export function ComparisonOperatorsSection() {
  return (
    <section>
      <h2 id="comparison-operators" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Comparison operators
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-6">
        Comparisons evaluate to{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">True</code> or{" "}
...
False`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Chained comparisons</h3>
...
False`}
      ...
      <div className="border-l-2 border-brand-primary bg-brand-primary/5 pl-4 py-3 rounded-r-lg mb-6">
        <p className="text-[13px] text-brand-text-muted italic">
          ...
          In <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">0 &lt; x &lt; 10</code>,
          if <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">0 &lt; x</code> is
          False, Python doesn&apos;t evaluate{" "}
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">x &lt; 10</code> at all.
        </p>
      </div>

      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">
        <code className="font-mono text-brand-primary">is</code> and{" "}
        <code className="font-mono text-brand-primary">is not</code>: identity, not equality
      </h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">is</code>{" "}
        checks whether two names point to the same object in memory, not whether they have the
        same value. Use it only for{" "}
...
False`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">
        <code className="font-mono text-brand-primary">in</code> and{" "}
        <code className="font-mono text-brand-primary">not in</code>: membership
      </h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        The{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">in</code>{" "}
        operator tests membership. It works on strings, lists, tuples, sets, dicts, and any{" "}
