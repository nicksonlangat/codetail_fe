...
export function ImmutabilitySection() {
  return (
    <section>
      <h2 id="immutability" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Immutability
      </h2>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        a{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">TypeError</code>.
      </p>
...
3`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">The mutable-inside gotcha</h3>
