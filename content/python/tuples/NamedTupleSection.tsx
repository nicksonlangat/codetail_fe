...
export function NamedTupleSection() {
  return (
    <section>
      <h2 id="named-tuples" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Named tuples
      </h2>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        you can write{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">p.x</code>{" "}
        instead of{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">p[0]</code>.
        It is still a tuple underneath and has no extra memory cost.
      </p>

      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">collections.namedtuple</h3>
...
2`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">typing.NamedTuple (preferred)</h3>
...
7.615773105863909`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">_replace() for immutable updates</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        You cannot modify a named tuple in place, but{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">_replace()</code>{" "}
...
Employee(name='Alice', dept='Engineering Lead', salary=110000)`}
      ...
      <div className="border-l-2 border-brand-primary bg-brand-primary/5 pl-4 py-3 rounded-r-lg mt-2 mb-6">
        <p className="text-[13px] font-semibold text-brand-text/80 mb-1">Named tuple vs dataclass</p>
