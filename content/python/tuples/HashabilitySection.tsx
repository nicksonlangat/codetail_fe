...
export function HashabilitySection() {
  return (
    <section>
      <h2 id="hashability" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Hashability
      </h2>
...
True`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Practical: graph traversal</h3>
...
print(bfs((0, 0), cells))`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">When tuples are not hashable</h3>
