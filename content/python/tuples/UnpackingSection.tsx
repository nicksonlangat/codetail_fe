...
export function UnpackingSection() {
  return (
    <section>
      <h2 id="unpacking" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
...
3 7`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Swap without a temp variable</h3>
...
20 10`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Starred unpacking</h3>
...
[2, 3, 4]`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Ignoring values with _</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        When a tuple has values you do not need, assign them to{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">_</code>.
