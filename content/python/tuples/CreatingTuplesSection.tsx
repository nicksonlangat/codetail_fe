...
export function CreatingTuplesSection() {
  return (
    <section>
      <h2 id="creating-tuples" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Creating tuples
      </h2>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        a tuple. The <Term term="comma">comma</Term> is what makes a tuple. Parentheses
        are just punctuation that improves readability.
      </p>
...
<class 'tuple'>`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">The single-element gotcha</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Creating a tuple with exactly one item trips up almost everyone the first time.
        Writing{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">(42)</code>{" "}
...
1`}
      ...
      <div className="border-l-2 border-brand-primary bg-brand-primary/5 pl-4 py-3 rounded-r-lg mt-2 mb-6">
        <p className="text-[13px] text-brand-text-muted italic">
          ...
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">(42,)</code>.
          That is a reminder that the comma is the real syntax, not the parentheses.
        </p>
      </div>

      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">The tuple() constructor</h3>
