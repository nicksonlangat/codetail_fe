...
export function WhileLoopsSection() {
  return (
    <section>
      <h2 id="while-loops" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        While loops
      </h2>
...
1 2 3 4`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">break and while / else</h3>
...
while n > 0:
    ...
    print("counted all the way down")   # not printed here`}
        output={`Found 7 after 11 attempts
stopped at 3`}
      />

      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Infinite loops with controlled exit</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">while True</code>{" "}
        with a{" "}
