...
export function GeneratorsSection() {
  return (
    <section>
      <h2 id="generators" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Generators
      </h2>
...
104`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Consuming a generator</h3>
...
[]`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Generator functions with yield</h3>
