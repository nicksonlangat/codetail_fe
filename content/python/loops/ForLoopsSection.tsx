...
export function ForLoopsSection() {
  return (
    <section>
      <h2 id="for-loops" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        For loops
      </h2>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">__iter__</code>.
...
Bob 78`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">range()</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">range()</code>{" "}
...
5 4 3 2 1`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">break and continue</h3>
...
1 3 5 7 9`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">for / else</h3>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">break</code>.
