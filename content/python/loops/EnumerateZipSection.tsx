...
export function EnumerateZipSection() {
  return (
    <section>
      <h2 id="enumerate-zip" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        enumerate and zip
      </h2>
      ...
      <h3 className="text-base font-semibold text-brand-text mb-3">enumerate()</h3>
...
3. cherry`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">zip()</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">zip()</code>{" "}
        stops at the shortest iterable. If you need to continue to the longest and fill
        missing values with a default, use{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">itertools.zip_longest()</code>.
      </p>
...
[(1, 10), (2, 20), (0, 30), (0, 40)]`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Combining enumerate and zip</h3>
