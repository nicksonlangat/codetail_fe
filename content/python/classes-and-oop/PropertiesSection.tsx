...
export function PropertiesSection() {
  return (
    <section>
      <h2 id="properties" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Properties
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        A{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">@property</code>{" "}
        turns a method into attribute-style access. Callers write{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">obj.radius</code>{" "}
        instead of{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">obj.radius()</code>,
...
ValueError: radius must be non-negative`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Two-way conversion</h3>
...
0.0`}
      ...
      <div className="border-l-2 border-brand-primary bg-brand-primary/5 pl-4 py-3 rounded-r-lg mt-2">
        <p className="text-[13px] text-brand-text-muted">
          ...
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">@property</code>{" "}
