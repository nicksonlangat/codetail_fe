...
export function DunderSection() {
  return (
    <section>
      <h2 id="dunder" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Dunder methods
      </h2>
...
True`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">__repr__ vs __str__</h3>
...
print(points)   # [Point(1, 2), Point(3, 4)]  __repr__ used inside list`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Sortable objects with @total_ordering</h3>
