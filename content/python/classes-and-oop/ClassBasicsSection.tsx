...
export function ClassBasicsSection() {
  return (
    <section>
      <h2 id="class-basics" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Class basics
      </h2>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        named <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">self</code>.
      </p>
...
BankAccount('Alice', 150)`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Class attributes vs instance attributes</h3>
