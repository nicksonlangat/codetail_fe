...
login_limiter = RateLimiter(5,   60)`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">@dataclass for pure data</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        When you need structured data without behavior,{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">@dataclass</code>{" "}
        generates{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">__init__</code>,{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">__repr__</code>,
        and{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">__eq__</code>{" "}
        for free.
      </p>
...
localhost 8080`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Composition over inheritance</h3>
