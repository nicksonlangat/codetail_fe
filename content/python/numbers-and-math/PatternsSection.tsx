...
export function PatternsSection() {
  return (
    <section>
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Clamp a value to a range</h3>
...
10`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Percentage calculations</h3>
      <CodeBlock
        code={`original = 120
discounted = 90
...
115.0`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Safe division</h3>
      <p className="text-[14px] text-brand-text/80 mb-3">
...
None`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Format numbers for display</h3>
      <CodeBlock
...
4.20e-03
 ...
 1,000`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Integer math tricks</h3>
      <CodeBlock
