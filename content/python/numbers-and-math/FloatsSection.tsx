...
export function FloatsSection() {
  return (
    <section>
      <h2 id="floats" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
...
False`}
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mt-6 mb-4">
        This isn&apos;t a Python bug. It&apos;s how floating-point math works in every language:
        C, Java, JavaScript, Go. Python is just honest about it.
      </p>

      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Why it happens</h3>
...
print(Decimal(0.1))`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Comparing floats correctly</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Never use <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">==</code>{" "}
        to compare floats. Use{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">math.isclose()</code>,
...
True`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Special float values</h3>
...
nan`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Float precision in practice</h3>
