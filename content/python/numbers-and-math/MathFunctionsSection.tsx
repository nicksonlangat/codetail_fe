...
export function MathFunctionsSection() {
  return (
    <section>
      <h2 id="math-functions" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Math functions
      </h2>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-6">
        ...
        and the{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">math</code>{" "}
        module for everything else.
      </p>

      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Built-in functions</h3>
...
24`}
      ...
      <div className="border-l-2 border-brand-warning bg-brand-warning/5 pl-4 py-3 rounded-r-lg mt-4 mb-8">
        <p className="text-[13px] text-brand-text-muted">
          <strong>Gotcha with round():</strong> Python uses banker&apos;s rounding (round
          half to even). So{" "}
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">round(0.5)</code> is{" "}
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">0</code> and{" "}
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">round(1.5)</code> is{" "}
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">2</code>. This
          reduces cumulative rounding error in statistical calculations, but it surprises
          people expecting standard rounding.
        </p>
      </div>

      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">The math module</h3>
