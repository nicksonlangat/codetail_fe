...
export function IntegersSection() {
  return (
    <section>
      <h2 id="integers" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Integers
      </h2>
...
93326215443944152681699238856266700490715968264381621468592963895217599993229915608941463976156518286253697920827223758251185210916864000000000000000000000000`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Integer literals</h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
...
0o377`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Underscore separators</h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
...
print(population)    # 8100000000: underscores stripped`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Bitwise operators</h3>
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
