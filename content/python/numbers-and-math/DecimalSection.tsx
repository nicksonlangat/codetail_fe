...
export function DecimalSection() {
  return (
    <section>
      <h2 id="decimal" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Decimal: when you need exact math
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        For money, taxes, and anything where a penny of error is unacceptable, use{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">decimal.Decimal</code>.
...
1.19075`}
      ...
      <div className="border-l-2 border-brand-warning bg-brand-warning/5 pl-4 py-3 rounded-r-lg mt-4 mb-6">
        <p className="text-[13px] text-brand-text-muted">
          ...
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">Decimal(0.1)</code>{" "}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Controlling precision and rounding</h3>
...
0.30`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">fractions.Fraction: exact rational math</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        For exact fraction arithmetic (1/3 + 1/6 = 1/2), use{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">fractions.Fraction</code>.
...
0.5`}
      ...
      <div className="border-l-2 border-brand-primary bg-brand-primary/5 pl-4 py-3 rounded-r-lg mt-4">
        <p className="text-[13px] text-brand-text-muted italic">
          Use <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">float</code> for
          science, graphics, and performance-critical code.
          Use <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">Decimal</code> for
          money and anything that will be displayed to users as a dollar amount.
          Use <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">Fraction</code> for
