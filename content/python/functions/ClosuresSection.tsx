...
export function ClosuresSection() {
  return (
    <section>
      <h2 id="closures" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Closures
      </h2>
...
30`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Closures with nonlocal state</h3>
...
10`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">The loop closure gotcha</h3>
