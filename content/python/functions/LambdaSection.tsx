...
export function LambdaSection() {
  return (
    <section>
      <h2 id="lambda" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Lambda and higher-order functions
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        A{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">lambda</code>{" "}
...
['fig', 'kiwi', 'apple', 'banana']`}
      ...
      <div className="border-l-2 border-brand-primary bg-brand-primary/5 pl-4 py-3 rounded-r-lg mt-2 mb-6">
        <p className="text-[13px] text-brand-text-muted italic">
          ...
          <code className="font-mono text-[12px] bg-brand-surface px-1 py-0.5 rounded">def</code>{" "}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Functions as arguments</h3>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        where behavior is passed in rather than hardcoded.
      </p>
...
Bob 78`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">functools.partial</h3>
