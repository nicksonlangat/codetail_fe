...
export function DefiningFunctionsSection() {
  return (
    <section>
      <h2 id="defining" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Defining functions
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        A function is defined with{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">def</code>,
        a name, parameters in parentheses, and a body. It runs only when called.
        Every function returns a value: if there is no{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">return</code>,
        it returns{" "}
...
None`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Type hints</h3>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">mypy</code>{" "}
...
None`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Early return</h3>
