...
export function ScopeSection() {
  return (
    <section>
      <h2 id="scope" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Scope
      </h2>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">NameError</code>{" "}
        is raised.
      </p>
...
global`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">global and nonlocal</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        By default, assigning to a name inside a function creates a local variable.
        Use{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">global</code>{" "}
        to modify a module-level variable, and{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">nonlocal</code>{" "}
