...
export function ParametersSection() {
  return (
    <section>
      <h2 id="parameters" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Parameters
      </h2>
      ...
      <h3 className="text-base font-semibold text-brand-text mb-3">Positional and keyword arguments</h3>
...
connecting to localhost:5432 (timeout=60s)`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">*args and **kwargs</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">*args</code>{" "}
        collects extra positional arguments into a tuple.{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">**kwargs</code>{" "}
...
kwargs: {'name': 'Alice', 'role': 'admin'}`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Keyword-only and positional-only</h3>
