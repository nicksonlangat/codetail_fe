...
export function WriteSection() {
  return (
    <section>
      <h2 id="writing" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Writing files
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Mode{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">&quot;w&quot;</code>{" "}
...
with open("log.txt", "a", encoding="utf-8") as f:
    f.write("2024-01-15 server started\\n")`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Writing structured data</h3>
...
with open("results.txt", "w", encoding="utf-8") as f:
    ...
    for row in rows:
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Binary files</h3>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">bytes</code>{" "}
