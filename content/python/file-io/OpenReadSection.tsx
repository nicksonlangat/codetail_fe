...
export function OpenReadSection() {
  return (
    <section>
      <h2 id="open-read" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Opening and reading files
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">open()</code>{" "}
...
with open("notes.txt") as f:
    first = f.readline()        # 'line 1\\n'`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Encoding</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Always specify{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">encoding=&quot;utf-8&quot;</code>{" "}
