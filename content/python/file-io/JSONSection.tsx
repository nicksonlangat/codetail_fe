  ...
  return (
    <section>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        module serializes Python objects to JSON strings and back. The four functions
        you need:{" "}
...
# Serialize to/from strings (e.g. for HTTP responses)
...
# json cannot serialize: sets, datetimes, custom classes
import datetime
...
"2024-01-15"`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Useful options</h3>
