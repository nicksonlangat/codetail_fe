...
export function PathlibSection() {
  return (
    <section>
      <h2 id="pathlib" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        pathlib
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">pathlib.Path</code>{" "}
        ...
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">os.path</code>.
...
/home/user/config/settings.json`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Common operations</h3>
...
for py_file in Path(".").rglob("*.py"):
    print(py_file)`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">File operations</h3>
