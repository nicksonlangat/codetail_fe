...
export function RaiseSection() {
  return (
    <section>
      <h2 id="raise" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Raising exceptions
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Use{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">raise</code>{" "}
...
ValueError: age must be between 0 and 150, got -1`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">raise from, chaining exceptions</h3>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">raise NewException from original</code>{" "}
...
'99'`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Custom exceptions</h3>
...
try:
    ...
    print(f"app error: {e}")   # catches any other AppError`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Re-raising</h3>
