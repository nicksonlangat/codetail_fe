...
export function ExceptionHierarchySection() {
  return (
    <section>
      <h2 id="hierarchy" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
        Exception hierarchy
      </h2>

      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        Python exceptions form a class hierarchy.{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">except SomeType</code>{" "}
        catches that type and all its subclasses. Catching{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">Exception</code>{" "}
        catches almost everything, but not{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">SystemExit</code>,{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">KeyboardInterrupt</code>, or{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">GeneratorExit</code>,
        which all inherit from{" "}
        <code className="font-mono text-[13px] bg-brand-surface px-1.5 py-0.5 rounded">BaseException</code>{" "}
