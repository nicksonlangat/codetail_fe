...
export function PatternsSection() {
  return (
    <section>
      ...
      <h3 className="text-base font-semibold text-brand-text mb-3">EAFP vs LBYL</h3>
      ...
      <p className="text-[15px] leading-relaxed text-brand-text/90 mb-4">
        ...
        and catches the failure. Python culture favors EAFP. It is often more readable
...
config = load_user_config("~/.myapp.json")`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Exception groups (Python 3.11+)</h3>
...
type errors: (TypeError('wrong type'),)`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">What not to do</h3>
