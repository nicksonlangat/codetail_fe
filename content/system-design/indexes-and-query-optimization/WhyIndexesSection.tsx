export function WhyIndexesSection() {
  return (
    <section>
      <h2 id="why-indexes" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
      ...
      <div className="bg-white border border-brand-border rounded-xl p-4 mb-6 not-prose">
        ...
        <pre className="text-[10px] font-mono text-brand-text/80 leading-relaxed whitespace-pre">{`-- Table: users (1,000,000 rows)
...
-- Time: ~200ms on a warm SSD`}</pre>
      ...
      <div className="bg-white border border-brand-border rounded-xl p-4 mb-6 not-prose">
        ...
        <pre className="text-[10px] font-mono text-brand-text/80 leading-relaxed whitespace-pre">{`-- Create the index once
...
-- Time: <1ms`}</pre>
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">The cost of indexes</h3>
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <span
                className={`ml-auto text-[9px] font-medium px-1.5 py-0.5 rounded ${
                  positive ? "bg-brand-primary/10 text-brand-primary" : "bg-brand-warning/10 text-brand-warning"
                }`}
              >
                {impact}
              </span>
            </div>
            <p className="text-[11px] text-brand-text-muted leading-relaxed">{detail}</p>
          </div>
        ))}
      </div>
