...
export function MonolithSection() {
  return (
    <section>
      <h2 id="monolith" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">The modular monolith</h3>
...
src/
  ...
  payments/
    ...
    models.py`}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">When a monolith genuinely struggles</h3>
      ...
      <div className="space-y-2 mb-6">
        {[
          ...
          <div key={signal} className="flex gap-3 p-3 rounded-xl border border-brand-warning/20 bg-brand-warning/5">
            <span className="text-brand-warning text-sm shrink-0 mt-0.5">!</span>
            <div>
              <p className="text-[12px] font-semibold text-brand-text mb-0.5">{signal}</p>
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Myths worth dispelling</h3>

      <div className="space-y-2">
        {MONOLITH_MYTHS.map(({ myth, reality }) => (
          <div key={myth} className="bg-white border border-brand-border rounded-xl p-3">
            <p className="text-[11px] font-semibold text-brand-warning mb-1">Myth: {myth}</p>
            <p className="text-[11px] text-brand-text-muted">Reality: {reality}</p>
          </div>
        ))}
      </div>
    </section>
