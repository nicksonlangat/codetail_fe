...
export function PartitionSection() {
  return (
    <section>
      <h2 id="partition-simulation" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
      ...
      <div className="grid gap-3 sm:grid-cols-2 mt-2">
        <div className="p-4 rounded-xl border border-brand-primary/20 bg-brand-primary/5">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-[10px] font-mono font-semibold bg-brand-primary/10 text-brand-primary px-2 py-0.5 rounded">
              CP
            </span>
            <span className="text-[12px] font-semibold text-brand-text">Consistency over Availability</span>
          </div>
          ...
          <p className="text-[10px] text-brand-text-muted">
            <span className="font-medium text-brand-text-muted">Real systems: </span>
            Zookeeper, etcd, HBase, Redis (Sentinel mode), MongoDB (primary-only reads)
          </p>
        </div>
        <div className="p-4 rounded-xl border border-brand-warning/20 bg-brand-warning/5">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-[10px] font-mono font-semibold bg-brand-warning/10 text-brand-warning px-2 py-0.5 rounded">
              AP
            </span>
            <span className="text-[12px] font-semibold text-brand-text">Availability over Consistency</span>
          </div>
          <p className="text-[11px] text-brand-text-muted leading-relaxed mb-3">
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Reconciliation in AP systems</h3>
      ...
      <div className="space-y-2">
        {[
          ...
          <div key={strategy} className="p-3 rounded-xl border border-brand-border bg-white text-[11px]">
            <p className="font-semibold text-brand-text mb-1">{strategy}</p>
            <p className="text-brand-text-muted leading-relaxed mb-1.5">{desc}</p>
            <p className="text-[10px] text-brand-text-muted">
              <span className="font-medium text-brand-text-muted">Used by: </span>
              {used}
            </p>
          </div>
        ))}
