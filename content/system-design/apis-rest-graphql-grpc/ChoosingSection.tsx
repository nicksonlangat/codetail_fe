...
export function ChoosingSection() {
  return (
    <section>
        ...
        <table className="w-full text-[11px] border-collapse">
          <thead>
            <tr className="border-b border-brand-border">
              ...
              <th className="text-left py-2 pr-2 text-brand-text-muted font-medium">REST</th>
              <th className="text-left py-2 pr-2 text-brand-text-muted font-medium">GraphQL</th>
              <th className="text-left py-2 pr-4 text-brand-text-muted font-medium">gRPC</th>
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Hybrid architectures</h3>
      ...
      <div className="space-y-4 mb-8">
        {HYBRID_PATTERNS.map(({ pattern, desc, example }) => (
          <div key={pattern} className="bg-white border border-brand-border rounded-xl overflow-hidden">
            <div className="px-4 py-2.5 border-b border-brand-border bg-brand-surface/30">
              <p className="text-[11px] font-semibold text-brand-text">{pattern}</p>
            </div>
            <div className="px-4 py-3 space-y-2">
              <p className="text-[11px] text-brand-text-muted">{desc}</p>
              <pre className="text-[10px] font-mono bg-brand-surface/50 rounded-lg px-3 py-2 overflow-x-auto text-brand-text-muted">
                {example}
              </pre>
            </div>
          </div>
