      ...
      <div className="space-y-4 mt-8">
        {[
          ...
          <div key={name} className="rounded-xl border border-brand-border bg-white overflow-hidden">
            <div className="px-4 py-3 bg-brand-surface/50 border-b border-brand-border">
              <span className="text-[13px] font-semibold text-brand-text">{name}</span>
            </div>
            <div className="p-4 space-y-3">
              <pre className="text-[10px] font-mono bg-brand-surface rounded-lg px-3 py-2.5 overflow-x-auto">{code}</pre>
