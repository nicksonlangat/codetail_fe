...
export function FailureModesSection() {
  return (
    <section>
      <h2 id="failure-modes" className="text-xl font-semibold text-brand-text mt-12 mb-4 scroll-mt-24">
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">Failure taxonomy</h3>
        ...
        {FAILURE_TYPES.map(({ type, desc, detection, danger }) => (
          <div key={type} className="bg-white border border-brand-border rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-3 space-y-1.5 text-[11px]">
              ...
              <p>
                <span className="font-medium text-brand-text/80">Detection: </span>
                <span className="text-brand-text-muted">{detection}</span>
              </p>
            </div>
          </div>
        ))}
      ...
      <h3 className="text-base font-semibold text-brand-text mt-8 mb-3">The fallacies of distributed computing</h3>
      ...
      <div className="grid gap-2 sm:grid-cols-2 mb-6">
        {[
          ...
          <div key={fallacy} className="bg-white border border-brand-border rounded-xl p-3">
            <p className="text-[11px] font-semibold text-brand-warning mb-1">Fallacy: {fallacy}</p>
            <p className="text-[11px] text-brand-text-muted">{reality}</p>
          </div>
        ))}
      </div>
    </section>
