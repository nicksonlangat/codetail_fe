...
import { conceptsArticles, getArticleBySlug, getAdjacentArticles } from "@/content/concepts/registry";
...
import { loadArticle } from "@/content/concepts/article-loader";

export function generateStaticParams() {
  return conceptsArticles.map((article) => ({ slug: article.slug }));
}
