...
import type { ArticleMeta } from "@/content/concepts/registry";
    ...
    <>
      ...
      >
        ...
        >
          ...
          <span>All Engineering Concepts</span>
        </Link>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-[10px] uppercase tracking-wider font-medium text-primary">
            Article {article.order} of {conceptsArticles.length}
          </span>
        </div>
