...
import { sqlArticles, getArticleBySlug, getAdjacentArticles } from "@/content/sql/registry";
...
import { loadArticle } from "@/content/sql/article-loader";

export function generateStaticParams() {
  return sqlArticles.map((article) => ({ slug: article.slug }));
}
