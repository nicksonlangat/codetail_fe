...
import type { ArticleMeta } from "@/content/system-design/registry";
    ...
    <>
      ...
      >
        ...
        >
          ...
          <span>All System Design articles</span>
        </Link>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-[10px] uppercase tracking-wider font-medium text-primary">
            Article {article.order} of {systemDesignArticles.length}
          </span>
        </div>
      ...
      >
        {prev ? (
          <Link
            href={`/blog/system-design/${prev.slug}`}
        ...
        {next && (
          <Link
            href={`/blog/system-design/${next.slug}`}
            className="group flex items-center gap-2 text-[12px] text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
          >
