...
const btnCls = "w-full h-[38px] rounded-[10px] border border-border bg-card text-[13px] font-medium text-foreground cursor-pointer transition-all duration-500 flex items-center justify-center gap-2.5 hover:bg-muted/50 hover:border-border";
