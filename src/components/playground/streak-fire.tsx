...
export function StreakFire() {
  ...
  useEffect(() => {
    const t = setTimeout(() => raw.set(STREAK), 300);
  ...
  return (
    <div className="flex justify-center py-6">
      <motion.div
        className="relative w-72 rounded-xl bg-card border border-border p-6 cursor-pointer overflow-hidden"
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 0%, hsl(164 70% 40% / 0.06), transparent 70%)",
          }}
